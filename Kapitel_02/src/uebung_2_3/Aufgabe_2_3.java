...
public class Aufgabe_2_3 {
    public static void main(String[] args) {
        ...
        // Declaring a variable for our scanner object and initialize it with a new scanner object
        ...
        b = sc.nextDouble();
        // Closing the scanner because it is a stream and streams should always be closed if we don´t need them anymore.
        ...
        //If the user enters a zero, a division by zero would be made. For this case we initialize result with NaN
