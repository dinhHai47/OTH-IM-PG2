...
public class Aufgabe_2_2 {
    public static void main(String[] args) {
        // Declaration and initialization. Using double is better for certain reasons instead of float.
        double a = 5.0;
        double b = 3.0;
        // Result variable
        double resultDouble;

        // Calculating as seen before, but printing the result each time twice. As Double and casted to Integer.
        ...
        //If at least one of the for division used variable is a floating point, the result is also floating point.
        int c = 5;
        int d = 3;
        ...
        resultDouble = c / b;
        System.out.println("Division von       " + c + " und " + b + " (Eine Integer, eine Double)   = " + resultDouble);
    }
}