...
public class VendingMachine {
	...
	public void chooseAndPayBeverage() {
		...
		while (unpayedCents > 0) {
			System.out.println("Bitte werfen Sie noch " + unpayedCents + " Cent ein. Gueltige Münzen: (10: 10 Cent, 20: 20 Cent, 50: 50 Cent)");
		...
		System.out.println("Vielen Dank fuer Ihren Kauf. Bitte entnehmen Sie Ihre Flasche " + bottle.getBeverageKind().getDescription() + ".");
