...
public class BadCodeSolution {
    ...
    public static void main(int[] args) {                       // Statt "int[] args" sollte es "String[] args" heißen!
        ...
        double d2 = sub(start, sc.nextFloat());                 // "start" unbekannt; Float statt Integer als Übergabewert, Aufruf der Methode nicht möglich, da "static" fehlt
    ...
    public int sub(int start, int sub) {                        
        return (start - sub);
    }
