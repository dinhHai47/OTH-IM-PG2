...
public class GleichheitArrays {
    ...
    public static boolean arraysEqual(int[] arr1, int[] arr2) {
        //if one of the arrays is null or if the diff in length, they are already not equal.
    ...
    //Methods can have the same name, as long the differ in their params. This method is for string-arrays
