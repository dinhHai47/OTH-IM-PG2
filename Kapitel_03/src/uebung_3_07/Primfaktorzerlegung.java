...
public class Primfaktorzerlegung {
	...
	public static long[] primeFactors(long n) {
		 ...
		 * zur�ckgegebene Array maximal soviele Elemente haben darf wie die Zahl n
		 ...
		 * gesichert, und die ganze Schleife wird "zurueckgesetzt", indem der Zaehler
		 * erneut bei 2 (1++) beginnt und n durch n/Primfaktor ersetzt wird.
		 */
		for (long j = 2; j <= n; j++) {
			// Ist j Primfaktor?
			if (n % j == 0) {
