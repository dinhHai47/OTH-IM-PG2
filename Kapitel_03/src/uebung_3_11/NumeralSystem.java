...
public class NumeralSystem {
    ...
    /*
     * Der in dieser Methode verwendete Algorithmus entspricht am ehesten der Konvertierung von Dezimal zu Binaer von Hand
     * Dabei wird die Dezimalzahl durch 2 geteilt und nachgesehen, ob bei der Division ein Rest entsteht. Dieser Rest
     * ist entweder 0 oder 1 und entspricht unserem gesuchten Bit, welches im Anschluss links an den binaryString "gehaengt"
     * wird. Dies geschieht so oft, bis bei einem Durchlauf die uebriggebliebene Dezimalzahl nur noch 0 entspricht und somit
     ...
     * Bit wird nun noch rechts and den binaryString angehaengt, wodurch sich am Ende das fuer die eingegebenen Zahl gesuchte
     * Bitmuster ergibt.
     */
    static String transformToBinaryAlternative2(int decimalNumber) {
        ...
        /*
         * Wir moechten nach der Umrechnung in die Binaerdarstellung so wenige Bits wie moeglich anzeigen.
         * Daher ist es notwendig herauszufinden, wie viele Bits wir mindestens brauchen, um die
         * uebergebene Dezimalzahl speichern zu koennen. Dies geschieht mit unten aufgefuehrter Formel
     ...
     * natuerlich in das Zahlensystem mit der Basis 16 um. Da hierfuer nicht nur 0en und 1en benoetigt
     * werden, sondern alle Ziffern von 0 bis 10, sowie die ersten Buchstaben des Alphabets, wird
     * zu Beginn ein Array mit eben diesen Werten angelegt. Mit Hilfe von Modulo laesst sich dann der
     * der entsprechende Wert finden und an den hexString links "anhaengen".
     */
